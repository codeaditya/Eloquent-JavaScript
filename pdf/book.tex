...
% https://tex.stackexchange.com/questions/764989/system-upgrade-introduced-a-new-error-scrtsolstlistinglinefill-undefined
\makeatletter \def\scr@tso@lstlisting@linefill{} \def\scr@tso@lstlisting@pagenumberformat#1{} \makeatother
\usepackage{geometry}
\usepackage{listings}
\usepackage{graphicx}
...
\thispagestyle{empty}
\noindent
\includegraphics[height=0.9\paperheight]{../img/cover.jpg}
\restoregeometry
\pagecolor{white}
